...
//     // Render tickets with checkboxes
//     function renderTicketsWithCheckboxes(tickets) {
...
//                 <p>Estimate: ${ticket.original_estimate}</p>
//                 <p>Assignee: ${ticket.name}</p>
//             `;

//             ticketCard.appendChild(checkbox);
//             ticketCard.innerHTML += ticketInfo;
//             ticketListContainer.appendChild(ticketCard);
//         });
//     }
...
//     // Handle exporting selected tickets
//     exportButton.addEventListener('click', () => {
//         const selectedCheckboxes = Array.from(document.querySelectorAll('.ticket-checkbox:checked'));
//         if (selectedCheckboxes.length === 0) {
//             alert("Please select at least one ticket to export.");
//             return;
//         }
...
//         const selectedTickets = selectedCheckboxes.map(checkbox =>
//             filteredTickets.find(ticket => ticket.TIC === checkbox.value)
//         );

//         exportTicketsAsPDF(selectedTickets); // Call PDF export function
//     });

//     // Initially render all tickets
//     renderTicketsWithCheckboxes(filteredTickets);
// });
